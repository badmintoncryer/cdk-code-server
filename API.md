...
| <code><a href="#cdk-code-server.CodeServer.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-code-server.CodeServer.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-code-server.CodeServer.with.parameter.mixins"></a>
